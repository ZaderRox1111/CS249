...
public class RegistrarClassMain
   {
    ...
    public static RegistrarClass makeData()
    {
    	RegistrarClass rc = new RegistrarClass();
    	StudentClass newItem, newItem1, newItem2, newItem3;
    	
    	newItem = new StudentClass("Johnson, Robert", 603667, 'M', 2.844077875);
    	rc.addStudent(newItem);
    	
    	newItem1 = new StudentClass("Elliott, Cayley", 135658, 'F', 2.978848017);
    	rc.addStudent(newItem1);
    	
    	newItem2 = new StudentClass("Ortega, Jane", 645168,	'F', 2.883788343);
    	rc.addStudent(newItem2);
    	
    	newItem3 = new StudentClass("Sibley, Ryan", 827402,	'F', 2.045116921);
    	rc.addStudent(newItem3);
